...
namespace LB12
{
    public partial class Form1 : Form
    {
        ...
        private void DirectConnection(int Size_Array)
        { 
            int[] unarray = array;
            int count_per = 0, compare = 0;
            int StartTime = Environment.TickCount;
        ...
        private void ChooseSort(int Size_Array)
        {
            int[] unsortedarray1 = array;
            int count_per = 0, compare = 0;
            int StartTime = Environment.TickCount;
